...
var Attachment = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: 'attachment_path', type: 'text' })
    ], Attachment.prototype, "attachmentPath");
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Message_1.Message; }, function (message) { return message.attachments; }),
        (0, typeorm_1.JoinColumn)({ name: 'message_id', referencedColumnName: 'id' })
    ], Attachment.prototype, "message");
    __decorate([
        (0, typeorm_1.BeforeInsert)(),
        (0, typeorm_1.BeforeUpdate)()
    ], Attachment.prototype, "validate");
