...
var User = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ type: 'text', name: 'first_name', "default": null })
    ...
    __decorate([
        (0, typeorm_1.Column)({ type: 'text', name: 'avatar_path', "default": null })
    ], User.prototype, "avatar");
    __decorate([
        (0, typeorm_1.Column)({ name: 'female' })
    ], User.prototype, "female");
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return Participant_1.Participant; }, function (participant) { return participant.user; })
    ], User.prototype, "participants");
    __decorate([
        (0, typeorm_1.ManyToMany)(function () { return User_1; }),
    ...
    ], User.prototype, "contacts");
    __decorate([
        (0, typeorm_1.ManyToMany)(function () { return Conversation_1.Conversation; }),
        (0, typeorm_1.JoinTable)({
            name: 'participants',
            joinColumn: { name: 'user', referencedColumnName: 'username' },
            inverseJoinColumn: { name: 'conversation_id', referencedColumnName: 'id' }
        })
    ], User.prototype, "conversations");
    __decorate([
